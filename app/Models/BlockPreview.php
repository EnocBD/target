...
class BlockPreview extends Model
{
    ...
    public function originalBlock()
    {
        return $this->belongsTo(Block::class, 'block_id');
    }

    // Propiedades de acceso para compatibilidad con las plantillas de bloques
    public function getImageAttribute()
    {
        return $this->image_path;
    }

    // Métodos helpers copiados del modelo Block
    ...
    // Método para convertir a Block cuando se guarda definitivamente
    ...
    public static function cleanupOldPreviews(int $hoursOld = 24)
    {
        return static::where('created_at', '<', now()->subHours($hoursOld))->delete();
    }
}
