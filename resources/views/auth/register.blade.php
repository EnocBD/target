...
<head>
    ...
    <title>Crear Cuenta - Target Eyewear</title>
    <!-- Google Fonts -->
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            @if ($errors->any())
                <div class="alert alert-danger">
                    <strong>Error en el registro.</strong> Por favor, corrige los errores e intenta nuevamente.
                </div>
            @endif
